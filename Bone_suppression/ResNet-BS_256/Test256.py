...
#load model:
resnet_bs.load_weights("C:/Users/EN308/Desktop/chuanyi/CXR-bone-suppression-main/test_256/ResNet-BS.bestjsrt4500.h5") 
print("Loaded model from disk")
resnet_bs.summary()


source = glob(r'C:\Users\EN308\Desktop\chuanyi\CXR-bone-suppression-main\prvide_data\*.jpg')
source.sort()
...
for f in source:
    ...
    imageio.imwrite("C:/Users/EN308/Desktop/chuanyi/CXR-bone-suppression-main/test_256/{}.png".format(img_name[:-4]), test_img)


##open image
#img = Image.open('C:/Users/EN308/Desktop/chuanyi/CXR-bone-suppression-main/prvide_data/image_004.jpg')
#img = img.resize((256,256)) 
#x = image.img_to_array(img)
#x = x.astype('float32') / 255
#imageio.imwrite('image_004_256.png',x)
#x1 = np.expand_dims(x, axis=0)
#t=time.time()
#pred = resnet_bs.predict(x1)
...
#imageio.imwrite('image_004.png', test_img)